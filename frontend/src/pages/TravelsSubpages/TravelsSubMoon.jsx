...
const TravelsSubMoon = () => {
  const { makeRequest, isLoading, data, error } = useRequestData();


  useEffect(() => {
    makeRequest("http://localhost:4444/tours/617f8116066b123e4c7c941c");
  }, []);
              ...
              <div className="flex flex-col space-y-10 md:flex-row">
                ...
                <div className="flex group md:w-1/2 items-center justify-center">
                  <div className="flex flex-col items-center text-center">
                    <h3 className="font-bold group-hover:text-primarycolor transition duration-500 text-white">
                      Tidligere kunder har givet turen:
                    </h3>
                    <p>
