...
import TureEditDelete from "./ADMIN-Travels/TureEditDelete";
import TureCreate from "./ADMIN-Travels/TureCreate";
...
const AdminTure = () => {
  ...
  return (
    <article className=" ">
      <div className="bg-blue-100">
        <div className="mycontainer flex justify-between space-y-1 px-5 py-3">
          ...
          <div className="flex flex-grow flex-col items-center space-y-2 md:flex-row md:justify-between md:space-y-0 md:px-20">
            <h1 className="text-center text-3xl text-gray-800">Ture ADMIN</h1>
      ...
      <div className="">
        {showEditDelete ? <TureEditDelete /> : <TureCreate />}
      </div>
    </article>
  );
};
